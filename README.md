...
* [lambda_function.py](Misc/Starter_Files/lambda_function.py)
* [correct_dialog.txt](Misc/Test_Cases/correct_dialog.txt)
* [age_error.txt](Misc/Test_Cases/age_error.txt)
* [incorrect_amount_error.txt](Misc/Test_Cases/incorrect_amount_error.txt)
* [negative_age_error.txt](Misc/Test_Cases/negative_age_error.txt)
...
![gear_icon](Misc/Images/gear_icon.png)
...
| Card 1                              | Card 2                              |
| ----------------------------------- | ----------------------------------- |
| ![Card 1 sample](Misc/Images/card1.png)  | ![Card 2 sample](Misc/Images/card2.png)  |

| Card 3                              | Card 4                              |
| ----------------------------------- | ----------------------------------- |
| ![Card 3 sample](Misc/Images/card3.png)  | ![Card 4 sample](Misc/Images/card4.png)  |
...
![Error handling configuration](Misc/Images/error_handling.png)
...
![Robo Advisor test](Misc/Images/bot-test-no-lambda.gif)
...
In the Lambda function, start by deleting the AWS generated default lines of code, then paste in the starter code provided in [lambda_function.py](Misc/Starter_Files/lambda_function.py) and complete the `recommend_portfolio()` function by following these guidelines:
...
Once you finish coding your lambda function, test it using the [sample test cases](Misc/Test_Cases/) provided for this homework.
...
![Robo Advisor test with Lambda](Misc/Images/bot-test-with-lambda.gif)
...
![Lex_Names1](Misc/Images/Lex_names1.png)
![Lex_Names2](Misc/Images/Lex_names2.png)
...
![Cryptocurrencies coins](Misc/Images/cryptocurrencies-coins.jpg)
...
* [crypto_clustering.ipynb](Misc/Starter_Files/crypto_clustering.ipynb)
...
3. Create a new DataFrame named `clustered_df`, that includes the following columns `"Algorithm", "ProofType", "TotalCoinsMined", "TotalCoinSupply", "PC 1", "PC 2", "PC 3", "CoinName", "Class"`. You should maintain the index of the `crypto_df` DataFrames as is shown bellow.
    ...
    ![clustered_df](Misc/Images/clustered_df.png)
